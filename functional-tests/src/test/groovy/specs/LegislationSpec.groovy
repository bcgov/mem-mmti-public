...
class LegislationSpec extends GebReportingSpec {
  ...
  def "Navigate Page from: LegislationPage, click main content Link: #ItemSelector, Assert Page: #AssertPage"() {
    ...
    where:
      ...
      [tag : "h4", text : "Mines Act (Ministry of Energy, Mines, and Low Carbon Innovation)"]                                                                                | [text : "Mines Act"]                                                         || new ExternalLinkPage("Mines Act", "www.bclaws.ca")
      [tag : "h4", text : "Mines Act (Ministry of Energy, Mines, and Low Carbon Innovation)"]                                                                                | [text : "Health, Safety and Reclamation Code for Mines in British Columbia"] || new ExternalLinkPage("Health, Safety and Reclamation Code for Mines in British Columbia - Province of British Columbia", "gov.bc.ca")
