...
class AuthorizationsSpec extends GebReportingSpec {
  ...
  def "Navigate Page from: AuthorizationsPage, click sidebar Link: #ItemSelector, Assert Page: #AssertPage"() {
    ...
    where:
      ...
      [tag : "h4", text : "EXTERNAL LINKS & RESOURCES"] | [text : "Major Mine Permitting Office (Ministry of Energy, Mines, and Low Carbon Innovation)"]                                  || new ExternalLinkPage("Major Mine Permitting Office (MMPO) - Province of British Columbia", "gov.bc.ca")
