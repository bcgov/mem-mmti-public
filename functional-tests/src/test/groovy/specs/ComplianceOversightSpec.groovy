...
class ComplianceOversightSpec extends GebReportingSpec {
  ...
  def "Navigate Page from: ComplianceOversightPage, click sidebar Link: #ItemSelector, Assert Page: #AssertPage"() {
    ...
    where:
      ...
      [tag : "h4", text : "EXTERNAL LINKS & RESOURCES"] | [text : "Environmental Assessment Office Compliance & Enforcement"]                                            || new ExternalLinkPage("Compliance &amp; Enforcement", "eao.gov.bc.ca")
