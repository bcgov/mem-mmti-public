...
class WaterQualitySpec extends GebReportingSpec {
  ...
  def "Navigate Page from: WaterQualityPage, click sidebar Link: #ItemSelector, Assert Page: #AssertPage"() {
    ...
    where:
      ...
      //TODO [tag : "h4", text : "EXTERNAL LINKS & RESOURCES"] | [text : "Government of Canada: Biological Monitoring"]                                                                                                            || new ExternalLinkPage("", "ec.gc.ca")
      [tag : "h4", text : "EXTERNAL LINKS & RESOURCES"] | [text : "Government of Canada: Water Quality"]                                                                                                                    || new ExternalLinkPage("Water and the environment - Canada.ca", "canada.ca")
